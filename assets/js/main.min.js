...
!function(e, t) {
    ...
    T.extend = T.fn.extend = function() {
        ...
        a--); a < s; a++)
            if (null != (e = arguments[a]))
                for (t in e)
                    n = e[t],
                    "__proto__" !== t && i !== n && (l && n && (T.isPlainObject(n) || (r = Array.isArray(n))) ? (o = i[t],
                    o = r && !Array.isArray(o) ? [] : r || T.isPlainObject(o) ? o : {},
                    r = !1,
                    i[t] = T.extend(l, o, n)) : void 0 !== n && (i[t] = n));
        return i
    }
    ,
    T.extend({
        ...
        makeArray: function(e, t) {
            t = t || [];
            return null != e && (Y(Object(e)) ? T.merge(t, "string" == typeof e ? [e] : e) : R.call(t, e)),
            t
        },
    ...
    var e = function(P) {
        ...
        var e, f, x, i, R, p, B, F, w, l, u, C, T, n, E, h, r, o, m, S = "sizzle" + +new Date, c = P.document, k = 0, $ = 0, W = L(), z = L(), U = L(), g = L(), X = function(e, t) {
            return e === t && (u = !0),
            0
        }, Q = {}.hasOwnProperty, t = [], Y = t.pop, V = t.push, A = t.push, G = t.slice, y = function(e, t) {
            for (var n = 0, r = e.length; n < r; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, K = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", a = "[\\x20\\t\\r\\n\\f]", s = "(?:\\\\[\\da-fA-F]{1,6}" + a + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", Z = "\\[" + a + "*(" + s + ")(?:" + a + "*([*^$|!~]?=)" + a + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + s + "))|)" + a + "*\\]", J = ":(" + s + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + Z + ")*)|.*)\\)|)", ee = new RegExp(a + "+","g"), v = new RegExp("^" + a + "+|((?:^|[^\\\\])(?:\\\\.)*)" + a + "+$","g"), te = new RegExp("^" + a + "*," + a + "*"), ne = new RegExp("^" + a + "*([>+~]|" + a + ")" + a + "*"), re = new RegExp(a + "|>"), oe = new RegExp(J), ie = new RegExp("^" + s + "$"), b = {
            ID: new RegExp("^#(" + s + ")"),
            CLASS: new RegExp("^\\.(" + s + ")"),
            TAG: new RegExp("^(" + s + "|[*])"),
            ATTR: new RegExp("^" + Z),
        ...
        }, ae = /HTML$/i, se = /^(?:input|select|textarea|button)$/i, le = /^h\d$/i, N = /^[^{]+\{\s*\[native \w/, ue = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ce = /[+~]/, j = new RegExp("\\\\[\\da-fA-F]{1,6}" + a + "?|\\\\([^\\r\\n\\f])","g"), de = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, fe = ye(function(e) {
        ...
        function I(t, e, n, r) {
            var o, i, a, s, l, u, c = e && e.ownerDocument, d = e ? e.nodeType : 9;
            if (n = n || [],
            ...
            E)) {
                    ...
                    if (o = s[1]) {
                        if (9 === d) {
                            ...
                            if (u.id === o)
                                return n.push(u),
                                n
                        } else if (c && (u = c.getElementById(o)) && m(e, u) && u.id === o)
                            return n.push(u),
                            n
                    } else {
                        if (s[2])
                ...
                if (f.qsa && !g[t + " "] && (!h || !h.test(t)) && (1 !== d || "object" !== e.nodeName.toLowerCase())) {
                    ...
                    1 === d && (re.test(t) || ne.test(t))) {
                        for ((c = ce.test(t) && ge(e.parentNode) || e) === e && f.scope || ((a = e.getAttribute("id")) ? a = a.replace(de, M) : e.setAttribute("id", a = S)),
                        i = (l = p(t)).length; i--; )
                            l[i] = (a ? "#" + a : ":scope") + " " + H(l[i]);
                        u = l.join(",")
                    }
        ...
        C = I.setDocument = function(e) {
            ...
            r = [],
            h = [],
            (f.qsa = N.test(T.querySelectorAll)) && (O(function(e) {
                var t;
            ...
            (f.matchesSelector = N.test(o = n.matches || n.webkitMatchesSelector || n.mozMatchesSelector || n.oMatchesSelector || n.msMatchesSelector)) && O(function(e) {
            ...
            m = e || N.test(n.contains) ? function(e, t) {
            ...
            X = e ? function(e, t) {
                var n;
                return e === t ? (u = !0,
                0) : (n = !e.compareDocumentPosition - !t.compareDocumentPosition) || (1 & (n = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !f.sortDetached && t.compareDocumentPosition(e) === n ? e == T || e.ownerDocument == c && m(c, e) ? -1 : t == T || t.ownerDocument == c && m(c, t) ? 1 : l ? y(l, e) - y(l, t) : 0 : 4 & n ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return u = !0,
                ...
                if (!o || !i)
                    return e == T ? -1 : t == T ? 1 : o ? -1 : i ? 1 : l ? y(l, e) - y(l, t) : 0;
                if (o === i)
                    return he(e, t);
        ...
        I.matchesSelector = function(e, t) {
            if (C(e),
            f.matchesSelector && E && !g[t + " "] && (!r || !r.test(t)) && (!h || !h.test(t)))
                try {
                    var n = o.call(e, t);
        ...
        (x = I.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return b.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && oe.test(n) && (t = (t = p(n, !0)) && n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(h, e, t, m, g) {
                    ...
                    : function(e, t, n) {
                        var r, o, i, a, s, l, u = v != y ? "nextSibling" : "previousSibling", c = e.parentNode, d = b && e.nodeName.toLowerCase(), f = !n && !b, p = !1;
                        if (c) {
                            if (v) {
                                for (; u; ) {
                                    for (a = e; a = a[u]; )
                            ...
                            y && f) {
                                ...
                                a = s && c.childNodes[s]; a = ++s && a && a[u] || (p = s = 0,
                                l.pop()); )
                                ...
                                for (; (a = ++s && a && a[u] || (p = s = 0,
                                l.pop())) && ((b ? a.nodeName.toLowerCase() !== d : 1 !== a.nodeType) || !++p || (f && ((o = (i = a[S] || (a[S] = {}))[a.uniqueID] || (i[a.uniqueID] = {}))[h] = [k, p]),
                                a !== e)); )
                                    ;
                ...
                PSEUDO: function(e, i) {
                    ...
                    x.setFilters.hasOwnProperty(e.toLowerCase()) ? D(function(e, t) {
            ...
            D(function(e, t, n, r) {
                var o, i, a, s = [], l = [], u = t.length, c = e || function(e, t, n) {
                    for (var r = 0, o = t.length; r < o; r++)
                        I(e, t[r], n);
                    return n
                }(h || "*", n.nodeType ? [n] : n, []), d = !p || !e && h ? c : xe(c, s, p, n, r), f = m ? v || (e ? p : u || g) ? [] : t : d;
                if (m && m(d, f, n, r),
                g)
                    for (o = xe(f, l),
                    g(o, [], n, r),
                ...
                if (e) {
                    if (v || p) {
                        ...
                        for (i = f.length; i--; )
                            (a = f[i]) && -1 < (o = v ? y(e, a) : s[i]) && (e[o] = !(t[o] = a))
                    }
                } else
        ...
        function Ce(g, v) {
            function e(e, t, n, r, o) {
                var i, a, s, l = 0, u = "0", c = e && [], d = [], f = w, p = e || b && x.find.TAG("*", o), h = k += null == f ? 1 : Math.random() || .1, m = p.length;
        ...
        p = I.tokenize = function(e, t) {
            ...
            s = [],
            l = x.preFilter; a; ) {
                for (i in n && !(r = te.exec(a)) || (r && (a = a.slice(r[0].length) || a),
                s.push(o = [])),
                n = !1,
                ...
                a = a.slice(n.length)),
                x.filter)
                    !(r = b[i].exec(a)) || l[i] && !(r = l[i](r)) || (n = r.shift(),
                    o.push({
                        value: n,
                        type: i,
                        matches: r
                ...
                for (n = (t = t || p(e)).length; n--; )
                    ((i = function e(t) {
                        for (var r, n, o, i = t.length, a = x.relative[t[0].type], s = a || x.relative[" "], l = a ? 1 : 0, u = ye(function(e) {
                            ...
                            return e = !a && (n || t !== w) || ((r = t).nodeType ? u : c)(e, t, n),
                            r = null,
                            e
                        }
                        ]; l < i; l++)
                            if (n = x.relative[t[l].type])
                                ...
                                if ((n = x.filter[t[l].type].apply(null, t[l].matches))[S]) {
                                    for (o = ++l; o < i && !x.relative[t[o].type]; o++)
                                        ;
                                    return we(1 < l && be(d), 1 < l && H(t.slice(0, l - 1).concat({
                                        value: " " === t[l - 2].type ? "*" : ""
                                    })).replace(v, "$1"), n, l < o && e(t.slice(l, o)), o < i && e(t = t.slice(o)), o < i && H(t))
                                }
                                d.push(n)
                            }
                        return be(d)
        ...
        F = I.select = function(e, t, n, r) {
            ...
            1 === c.length) {
                ...
                for (o = b.needsContext.test(e) ? 0 : i.length; o-- && (a = i[o],
                !x.relative[s = a.type]); )
            ...
            return (u || B(e, c))(r, t, !E, n, !t || ce.test(e) && ge(t.parentNode) || t),
            n
        }
        ,
    ...
    var J, ee = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, te = ((T.fn.init = function(e, t, n) {
        if (e) {
            if (n = n || J,
            "string" != typeof e)
            ...
            if (r[1]) {
                ...
                T.merge(this, T.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : C, !0)),
    ...
    T.each({
        ...
        contents: function(e) {
            return null != e.contentDocument && M(e.contentDocument) ? e.contentDocument : (l(e, "template") && (e = e.content || e),
        ...
        T.fn[r] = function(e, t) {
            ...
            1 < this.length && (ne[r] || T.uniqueSort(n),
            te.test(r)) && n.reverse(),
            this.pushStack(n)
        }
    });
    ...
    T.Callbacks = function(r) {
        ...
        var i, t, a, s, l = [], u = [], c = -1, d = {
            add: function() {
                return l && (t && !i && (c = l.length - 1,
                u.push(t)),
                function n(e) {
    ...
    T.extend({
                            ...
                            function e() {
                                ...
                                if (!(o < l)) {
                                    ...
                                    if (typeof a !== "function") {
                                        console.error("a is not a function");
                                        return;
                                    }
                
                                    if (!n || !r) {
                                        console.error("n or r is not defined");
                                        return;
                                    }
                                    ...
                                    y(t) ? s ? t.call(e, u(l, i, c, s), u(l, i, oe, s)) : (l++,
                                    t.call(e, u(l, i, c, s), u(l, i, oe, s), u(l, i, c, i.notifyWith))) : (a !== c && (n = void 0,
                                    r = [e]),
                                    (s || i.resolveWith)(n, r))
                                }
                            }
        ...
        when: function(e) {
            ...
            var n = arguments.length
              ...
              , i = s.call(arguments)
              , a = T.Deferred();
            if (n <= 1 && (ie(e, a.done(t(r)).resolve, a.reject, !n),
    ...
    var ae = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/
      , se = (T.Deferred.exceptionHook = function(e, t) {
    ...
    "complete" === C.readyState || "loading" !== C.readyState && !C.documentElement.doScroll ? w.setTimeout(T.ready) : (C.addEventListener("DOMContentLoaded", le),
        ...
        data: function(n, e) {
            ...
            if (void 0 !== n)
                return "object" == typeof n ? this.each(function() {
                    ...
                    var t;
                    if (i && void 0 === e)
                        return void 0 !== (t = u.get(i, n)) || void 0 !== (t = me(i, n)) ? t : void 0;
                    this.each(function() {
                        u.set(this, n, e)
                    })
    ...
    T.extend({
        queue: function(e, t, n) {
            ...
            if (e)
                ...
                n && (!r || Array.isArray(n) ? r = x.access(e, t, T.makeArray(n)) : r.push(n)),
                r || []
        },
    ...
    T.fn.extend({
        ...
        promise: function(e, t) {
            ...
            var r, o = 1, i = T.Deferred(), a = this, s = this.length;
            for ("string" != typeof e && (t = e,
            e = void 0),
            e = e || "fx"; s--; )
                (r = x.get(a[s], e + "queueHooks")) && r.empty && (o++,
                r.empty.add(n));
            return n(),
            i.promise(t)
        }
    ...
    function be(e, t, n, r) {
        ...
        , l = s(), u = n && n[3] || (T.cssNumber[t] ? "" : "px"), c = e.nodeType && (T.cssNumber[t] || "px" !== u && +l) && ve.exec(T.css(e, t));
        if (c && c[3] !== u) {
            for (u = u || c[3],
            c = +(l /= 2) || 1; a--; )
                T.style(e, t, c + u),
    ...
    function A(e, t) {
        for (var n, r, o, i, a, s = [], l = 0, u = e.length; l < u; l++)
            ...
            t ? ("none" === n && (s[l] = x.get(r, "display") || null,
            s[l] || (r.style.display = "")),
            "" === r.style.display && ge(r) && (s[l] = (a = i = void 0,
            i = (o = r).ownerDocument,
            o = o.nodeName,
            (a = xe[o]) || (i = i.body.appendChild(i.createElement(o)),
            a = T.css(i, "display"),
    ...
    var we = /^(?:checkbox|radio)$/i
      ...
      , N = (D = C.createDocumentFragment().appendChild(C.createElement("div")),
    ...
    N.th = N.td,
    g.option || (N.optgroup = N.option = [1, "<select multiple='multiple'>", "</select>"]);
    var Se = /<|&#?\w+;/;
    function ke(e, t, n, r, o) {
        for (var i, a, s, l, u, c = t.createDocumentFragment(), d = [], f = 0, p = e.length; f < p; f++)
            if ((i = e[f]) || 0 === i)
                if ("object" === h(i))
                    T.merge(d, i.nodeType ? [i] : i);
                else if (Se.test(i)) {
        ...
        for (c.textContent = "",
        f = 0; i = d[f++]; )
            if (r && -1 < T.inArray(i, r))
                o && o.push(i);
            else if (l = k(i),
            a = j(c.appendChild(i), "script"),
            l && Ee(a),
            n)
                for (u = 0; i = a[u++]; )
    ...
    T.event = {
        ...
        add: function(t, e, n, r, o) {
            var i, a, s, l, u, c, d, f, p, h = x.get(t);
            if (v(t))
        ...
        remove: function(e, t, n, r, o) {
            var i, a, s, l, u, c, d, f, p, h, m, g = x.hasData(e) && x.get(e);
            if (g && (l = g.events)) {
                for (u = (t = (t || "").match(E) || [""]).length; u--; )
                    if (p = m = (s = Ae.exec(t[u]) || [])[1],
                    h = (s[2] || "").split(".").sort(),
                    p) {
                        ...
                        a && !f.length && (d.teardown && !1 !== d.teardown.call(e, h, g.handle) || T.removeEvent(e, p, g.handle),
                        delete l[p])
                    } else
                        for (p in l)
        ...
        dispatch: function(e) {
            var t, n, r, o, i, a = new Array(arguments.length), s = T.event.fix(e), e = (x.get(this, "events") || Object.create(null))[s.type] || [], l = T.event.special[s.type] || {};
            for (a[0] = s,
            t = 1; t < arguments.length; t++)
                a[t] = arguments[t];
            if (s.delegateTarget = this,
            !l.preDispatch || !1 !== l.preDispatch.call(this, s)) {
                for (i = T.event.handlers.call(this, s, e),
                t = 0; (r = i[t++]) && !s.isPropagationStopped(); )
                    ...
                    n = 0; (o = r.handlers[n++]) && !s.isImmediatePropagationStopped(); )
                        ...
                        s.data = o.data,
                        void 0 !== (o = ((T.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, a)) && !1 === (s.result = o) && (s.preventDefault(),
                        s.stopPropagation()));
            ...
            if (l && u.nodeType && !("click" === e.type && 1 <= e.button))
                for (; u !== this; u = u.parentNode || this)
                    if (1 === u.nodeType && ("click" !== e.type || !0 !== u.disabled)) {
                        ...
                        a = {},
                        n = 0; n < l; n++)
                            void 0 === a[o = (r = t[n]).selector + " "] && (a[o] = r.needsContext ? -1 < T(o, this).index(u) : T.find(o, this, null, [u]).length),
                            a[o] && i.push(r);
                        i.length && s.push({
                            elem: u,
                            handlers: i
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    e = this || e;
                    return we.test(e.type) && e.click && l(e, "input") && Ie(e, "click", n),
                    !1
                },
                trigger: function(e) {
                    e = this || e;
                    return we.test(e.type) && e.click && l(e, "input") && Ie(e, "click"),
                    !0
                },
                _default: function(e) {
                    e = e.target;
    ...
    function I(n, r, o, i) {
        r = _(r);
        var e, t, a, s, l, u, c = 0, d = n.length, f = d - 1, p = r[0], h = y(p);
        ...
        if (d && (t = (e = ke(r, n[0].ownerDocument, !1, n, i)).firstChild,
        1 === e.childNodes.length && (e = t),
        t || i)) {
            for (s = (a = T.map(j(e, "script"), He)).length; c < d; c++)
                l = e,
                c !== f && (l = T.clone(l, !0, !0),
                s) && T.merge(a, j(l, "script")),
                o.call(n[c], l, c);
            if (s)
                ...
                c = 0; c < s; c++)
                    l = a[c],
                    Te.test(l.type || "") && !x.access(l, "globalEval") && T.contains(u, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? T._evalUrl && !l.noModule && T._evalUrl(l.src, {
                        nonce: l.nonce || l.getAttribute("nonce")
                    }, u) : Q(l.textContent.replace(Oe, ""), l, u))
        }
        return n
    }
    function _e(e, t, n) {
    ...
    T.extend({
        ...
        clone: function(e, t, n) {
            var r, o, i, a, s, l, u, c = e.cloneNode(!0), d = k(e);
            ...
            if (t)
                if (n)
                    ...
                    Me(e, c);
            return 0 < (a = j(c, "script")).length && Ee(a, !d && j(e, "script")),
            c
        },
    ...
    T.fn.extend({
        ...
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++)
                1 === e.nodeType && (T.cleanData(j(e, !1)),
                e.textContent = "");
            return this
        },
        clone: function(e, t) {
        ...
        html: function(e) {
            return d(this, function(e) {
                ...
                if ("string" == typeof e && !Le.test(e) && !N[(Ce.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; n < r; n++)
                            1 === (t = this[n] || {}).nodeType && (T.cleanData(j(t, !1)),
                            t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        replaceWith: function() {
            ...
            return I(this, arguments, function(e) {
                ...
                T.inArray(this, n) < 0 && (T.cleanData(j(this)),
    ...
    var Fe, $e, We, ze, Ue, Xe, Qe, o, Ye = new RegExp("^(" + e + ")(?!px)[a-z%]+$","i"), Ve = new RegExp(f.join("|"),"i");
    function Ge() {
        var e;
    ...
    function Ze(e, t, n) {
        var r, o, i = e.style;
        return (n = n || Re(e)) && ("" !== (o = n.getPropertyValue(t) || n[t]) || k(e) || (o = T.style(e, t)),
        !g.pixelBoxStyles()) && Ye.test(o) && Ve.test(t) && (e = i.width,
        t = i.minWidth,
        r = i.maxWidth,
    ...
    function ut(e, t, n, r, o, i) {
        ...
        for (; a < 4; a += 2)
            ...
            r ? ("content" === n && (l -= T.css(e, "padding" + f[a], !0, o)),
            "margin" !== n && (l -= T.css(e, "border" + f[a] + "Width", !0, o))) : (l += T.css(e, "padding" + f[a], !0, o),
            "padding" !== n ? l += T.css(e, "border" + f[a] + "Width", !0, o) : s += T.css(e, "border" + f[a] + "Width", !0, o));
    ...
    function ct(e, t, n) {
        ...
        return (!g.boxSizingReliable() && o || !g.reliableTrDimensions() && l(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === T.css(e, "display", !1, r)) && e.getClientRects().length && (o = "border-box" === T.css(e, "boxSizing", !1, r),
        i = s in e) && (a = e[s]),
    ...
    T.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, i, a, s = b(t), l = it.test(t), u = e.style;
                if (l || (t = rt(s)),
                a = T.cssHooks[t] || T.cssHooks[s],
                void 0 === n)
                    return a && "get"in a && void 0 !== (o = a.get(e, !1, r)) ? o : u[t];
                "string" === (i = typeof n) && (o = ve.exec(n)) && o[1] && (n = be(e, t, o),
                i = "number"),
    ...
    T.each(["height", "width"], function(e, a) {
        T.cssHooks[a] = {
            get: function(e, t, n) {
                if (t)
                    return !ot.test(T.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? ct(e, a, n) : Be(e, at, function() {
                        return ct(e, a, n)
                    })
            },
            set: function(e, t, n) {
                var r = Re(e)
                  ...
                  , n = n ? ut(e, a, n, i, r) : 0;
                return i && o && (n -= Math.ceil(e["offset" + a[0].toUpperCase() + a.slice(1)] - parseFloat(r[a]) - ut(e, a, "border", !1, r) - .5)),
                n && (i = ve.exec(t)) && "px" !== (i[3] || "px") && (e.style[a] = t,
                t = T.css(e, a)),
                lt(0, t, n)
            }
        }
    ...
    T.fx.step = {};
    var L, dt, a, D, ft = /^(?:toggle|show|hide)$/, pt = /queueHooks$/;
    function ht() {
        dt && (!1 === C.hidden && w.requestAnimationFrame ? w.requestAnimationFrame(ht) : w.setTimeout(ht, T.fx.interval),
        T.fx.tick())
    }
    function mt() {
    ...
    function vt(e, t, n) {
        for (var r, o = (O.tweeners[t] || []).concat(O.tweeners["*"]), i = 0, a = o.length; i < a; i++)
            if (r = o[i].call(n, t, e))
                return r
    }
    function O(o, e, t) {
        var n, i, r, a, s, l, u, c = 0, d = O.prefilters.length, f = T.Deferred().always(function() {
            delete p.elem
        }), p = function() {
            if (!i) {
                for (var e = L || mt(), e = Math.max(0, h.startTime + h.duration - e), t = 1 - (e / h.duration || 0), n = 0, r = h.tweens.length; n < r; n++)
                    h.tweens[n].run(t);
    ...
    T.Animation = T.extend(O, {
        ...
        tweener: function(e, t) {
            ...
            ["*"]) : e.match(E)).length; r < o; r++)
                n = e[r],
                O.tweeners[n] = O.tweeners[n] || [],
                O.tweeners[n].unshift(t)
        },
        prefilters: [function(e, t, n) {
            var r, o, i, a, s, l, u, c = "width"in t || "height"in t, d = this, f = {}, p = e.style, h = e.nodeType && ge(e), m = x.get(e, "fxshow");
            ...
            if ((l = !T.isEmptyObject(t)) || !T.isEmptyObject(f))
                ...
                "none" === (c = T.css(e, "display")) && (u ? c = u : (A([e], !0),
                u = e.style.display || u,
                c = T.css(e, "display"),
                A([e]))),
                ...
                l = !1,
                f)
                    l || (m ? "hidden"in m && (h = m.hidden) : m = x.access(e, "fxshow", {
                        display: u
                    }),
                    i && (m.hidden = !h),
                    h && A([e], !0),
    ...
    T.fn.extend({
        ...
        finish: function(a) {
            return !1 !== a && (a = a || "fx"),
            this.each(function() {
                var e, t = x.get(this), n = t[a + "queue"], r = t[a + "queueHooks"], o = T.timers, i = n ? n.length : 0;
                for (t.finish = !0,
                T.queue(this, a, []),
    ...
    var yt, bt = T.expr.attrHandle, xt = (T.fn.extend({
        attr: function(e, t) {
    ...
    T.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== i && 8 !== i && 2 !== i)
                return void 0 === e.getAttribute ? T.prop(e, t, n) : (1 === i && T.isXMLDoc(e) || (o = T.attrHooks[t.toLowerCase()] || (T.expr.match.bool.test(t) ? yt : void 0)),
                void 0 !== n ? null === n ? void T.removeAttr(e, t) : o && "set"in o && void 0 !== (r = o.set(e, n, t)) ? r : (e.setAttribute(t, n + ""),
                n) : !(o && "get"in o && null !== (r = o.get(e, t))) && null == (r = T.find.attr(e, t)) ? void 0 : r)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        toggleClass: function(o, t) {
            ...
            return "boolean" == typeof t && a ? t ? this.addClass(o) : this.removeClass(o) : y(o) ? this.each(function(e) {
                ...
                if (a)
                    ...
                    void 0 !== o && "boolean" != i || ((e = H(this)) && x.set(this, "__className__", e),
      ...
      , St = (T.fn.extend({
        val: function(t) {
            ...
            this.each(function(e) {
                1 !== this.nodeType || (null == (e = r ? t.call(this, e, T(this).val()) : t) ? e = "" : "number" == typeof e ? e += "" : Array.isArray(e) && (e = T.map(e, function(e) {
                    return null == e ? "" : e + ""
                })),
            ...
            select: {
                ...
                set: function(e, t) {
                    for (var n, r, o = e.options, i = T.makeArray(t), a = o.length; a--; )
                        ((r = o[a]).selected = -1 < T.inArray(T.valHooks.option.get(r), i)) && (n = !0);
    ...
    /^(?:focusinfocus|focusoutblur)$/)
      , kt = (T.extend(T.event, {
        trigger: function(e, t, n, r) {
            var o, i, a, s, l, u, c, d = [n || C], f = W.call(e, "type") ? e.type : e, p = W.call(e, "namespace") ? e.namespace.split(".") : [], h = c = i = n = n || C;
            if (3 !== n.nodeType && 8 !== n.nodeType && !St.test(f + T.event.triggered) && (-1 < f.indexOf(".") && (f = (p = f.split(".")).shift(),
            p.sort()),
            s = f.indexOf(":") < 0 && "on" + f,
            ...
            r || !u.trigger || !1 !== u.trigger.apply(n, t))) {
                ...
                for (o = 0; (h = d[o++]) && !e.isPropagationStopped(); )
                    ...
                    (l = s && h[s]) && l.apply && v(h) && (e.result = l.apply(h, t),
                    !1 === e.result) && e.preventDefault();
                return e.type = f,
                r || e.isDefaultPrevented() || u._default && !1 !== u._default.apply(d.pop(), t) || !v(n) || s && y(n[f]) && !m(n) && ((i = n[s]) && (n[s] = null),
                T.event.triggered = f,
    ...
    g.focusin || T.each({
        ...
        T.event.special[r] = {
            ...
            teardown: function() {
                var e = this.ownerDocument || this.document || this
                  , t = x.access(e, r) - 1;
                t ? x.access(e, r, t) : (e.removeEventListener(n, o, !0),
                x.remove(e, r))
            }
        }
    }),
    ...
    T.extend({
        ...
        ajax: function(e, t) {
            "object" == typeof e && (t = e,
            e = void 0);
            var l, u, c, n, d, f, p, r, h = T.ajaxSetup({}, t = t || {}), m = h.context || h, g = h.context && (m.nodeType || m.jquery) ? T(m) : T.event, v = T.Deferred(), y = T.Callbacks("once memory"), b = h.statusCode || {}, o = {}, i = {}, a = "canceled", x = {
                readyState: 0,
            ...
            null == h.crossDomain) {
                ...
                try {
                    e.href = h.url,
                    e.href = e.href,
                    h.crossDomain = $t.protocol + "//" + $t.host != e.protocol + "//" + e.host
                } catch (e) {
                    h.crossDomain = !0
                }
            }
            ...
            !f) {
                ...
                u = h.url.replace(qt, ""),
                h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Ot, "+")) : (e = h.url.slice(u.length),
                h.data && (h.processData || "string" == typeof h.data) && (u += (Nt.test(u) ? "&" : "?") + h.data,
                delete h.data),
                !1 === h.cache && (u = u.replace(Ht, "$1"),
                e = (Nt.test(u) ? "&" : "?") + "_=" + At.guid++ + e),
                h.url = u + e),
                h.ifModified && (T.lastModified[u] && x.setRequestHeader("If-Modified-Since", T.lastModified[u]),
                T.etag[u]) && x.setRequestHeader("If-None-Match", T.etag[u]),
            ...
            function s(e, t, n, r) {
                ...
                r ? (h.ifModified && ((n = x.getResponseHeader("Last-Modified")) && (T.lastModified[u] = n),
                n = x.getResponseHeader("etag")) && (T.etag[u] = n),
    ...
    var Xt = {
      ...
      , Yt = (g.cors = !!Qt && "withCredentials"in Qt,
    g.ajax = Qt = !!Qt,
    ...
    T.ajaxPrefilter("json jsonp", function(e, t, n) {
        ...
        if (a || "jsonp" === e.dataTypes[0])
            ...
            e.converters["script json"] = function() {
                return i || T.error(r + " was not called"),
                i[0]
            }
            ,
            e.dataTypes[0] = "json",
    ...
    T.parseHTML = function(e, t, n) {
        ...
        r = !n && [],
        (n = K.exec(e)) ? [t.createElement(n[1])] : (n = ke([e], t, r),
    ...
    T.offset = {
        setOffset: function(e, t, n) {
            var r, o, i, a, s = T.css(e, "position"), l = T(e), u = {};
            "static" === s && (e.style.position = "relative"),
            i = l.offset(),
            r = T.css(e, "top"),
            a = T.css(e, "left"),
            s = ("absolute" === s || "fixed" === s) && -1 < (r + a).indexOf("auto") ? (o = (s = l.position()).top,
        ...
        T.each({
            ...
            T.fn[i] = function(e, t) {
                ...
                return d(this, function(e, t, n) {
                    ...
                    Math.max(e.body["scroll" + a], r["scroll" + a], e.body["offset" + a], r["offset" + a], r["client" + a])) : void 0 === n ? T.css(e, t, o) : T.style(e, t, n, o)
                }, s, n ? e : void 0, n)
            }
        })
    }),
...
function(e, t) {
    ...
    var p = {
      ...
      , h = function(e, t, n) {
        n.settings.events && (e = new CustomEvent(e,{
            bubbles: !0,
            cancelable: !0,
            detail: n
        }),
    ...
    i.fn.fitVids = function(e) {
        ...
        this.each(function() {
            var e = ['iframe[src*="player.vimeo.com"]', 'iframe[src*="youtube.com"]', 'iframe[src*="youtube-nocookie.com"]', 'iframe[src*="kickstarter.com"][src*="video.html"]', "object", "embed"]
              , r = (o.customSelector && e.push(o.customSelector),
            ".fitvidsignore")
              , e = (o.ignore && (r = r + ", " + o.ignore),
            i(this).find(e.join(",")));
...
$(function() {
    var n, r, e, o, t = $("nav.greedy-nav .greedy-nav__toggle"), i = $("nav.greedy-nav .visible-links"), a = $("nav.greedy-nav .hidden-links"), s = $("nav.greedy-nav"), l = $("nav.greedy-nav .site-logo"), u = $("nav.greedy-nav .site-logo img"), c = $("nav.greedy-nav .site-title"), d = $("nav.greedy-nav button.search__toggle");
    function f() {
        function t(e, t) {
            r += t,
            n += 1,
...
function(e) {
    ...
    function p(e) {
        return e === n && h.currTemplate.closeBtn || (h.currTemplate.closeBtn = u(h.st.closeMarkup.replace("%title%", h.st.tClose)),
        n = e),
    ...
    var h, r, m, s, g, n, l, v, y, b, x = "Close", P = "BeforeClose", w = "MarkupParse", C = "Open", T = ".mfp", E = "mfp-ready", M = "mfp-removing", S = "mfp-prevent-close", k = !!window.jQuery, A = u(window), N = (u.magnificPopup = {
        instance: null,
        proto: e.prototype = {
            constructor: e,
            init: function() {
            ...
            open: function(e) {
                ...
                if (!h.isOpen) {
                    ...
                    h.bgOverlay || (h.bgOverlay = d("bg").on("click" + T, function() {
                        h.close()
                    }),
                    h.wrap = d("wrap").attr("tabindex", -1).on("click" + T, function(e) {
                    ...
                    f("BeforeOpen"),
                    h.st.showCloseBtn && (h.st.closeBtnInside ? (c(w, function(e, t, n, r) {
                    ...
                    var a = h.wH = A.height()
                      , s = {}
                      , l = (h.fixedContentPos && h._hasScrollBar(a) && (l = h._getScrollbarSize()) && (s.marginRight = l),
                    ...
                    setTimeout(function() {
                        h.content ? (h._addClassToMFP(E),
                        h._setFocus()) : h.bgOverlay.addClass(E),
            ...
            close: function() {
                h.isOpen && (f(P),
                h.isOpen = !1,
                h.st.removalDelay && !h.isLowIE && h.supportsTransition ? (h._addClassToMFP(M),
                setTimeout(function() {
                    h._close()
            ...
            _parseMarkup: function(o, e, t) {
                ...
                u.each(e, function(e, t) {
                    if (void 0 === t || !1 === t)
                        return !0;
                    var n, r;
                    1 < (i = e.split("_")).length ? 0 < (n = o.find(T + "-" + i[0])).length && ("replaceWith" === (r = i[1]) ? n[0] !== t[0] && n.replaceWith(t) : "img" === r ? n.is("img") ? n.attr("src", t) : n.replaceWith(u("<img>").attr("src", t).attr("class", n.attr("class"))) : n.attr(i[1], t)) : o.find(T + "-" + e).html(t)
                })
            },
    ...
    u.fn.magnificPopup = function(e) {
        i();
        var t, n, r, o = u(this);
        return "string" == typeof e ? "open" === e ? (t = k ? o.data("magnificPopup") : o[0].magnificPopup,
    ...
    ,
    "inline"), j = (u.magnificPopup.registerModule(N, {
        options: {
            hiddenClass: "hide",
            markup: "",
        ...
        proto: {
            ...
            getInline: function(e, t) {
                ...
                return a(),
                e.src ? (n = h.st.inline,
                (r = u(e.src)).length ? ((o = r[0].parentNode) && o.tagName && (v || (l = n.hiddenClass,
                v = d(l),
                l = "mfp-" + l),
                y = r.after(v).detach().removeClass(l)),
                h.updateStatus("ready")) : (h.updateStatus("error", n.tNotFound),
                r = u("<div>")),
        ...
        proto: {
            ...
            findImageSize: function(t) {
                function n(e) {
                    ...
                    I = setInterval(function() {
                        0 < o.naturalWidth ? h._onImageHasSize(t) : (200 < r && clearInterval(I),
            ...
            getImage: function(e, t) {
                function n() {
                    ...
                    e.hasSize = !0,
                    e.loaded = !0,
                    f("ImageLoadComplete")) : ++i < 200 ? setTimeout(n, 100) : r())
                }
                function r() {
                ...
                var o, i = 0, a = h.st.image, s = t.find(".mfp-img");
                return s.length && ((o = document.createElement("img")).className = "mfp-img",
    ...
    function L(e) {
        var t;
        h.currTemplate[q] && (t = h.currTemplate[q].find("iframe")).length && (e || (t[0].src = "//about:blank"),
        ...
        proto: {
            initZoom: function() {
                ...
                n = function(e) {
                    var e = e.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image")
                      ...
                      , r = "transition";
                    return n["-webkit-" + r] = n["-moz-" + r] = n["-o-" + r] = n[r] = t,
                    e.css(n),
                    e
                }
                ,
            ...
            _getOffset: function(e) {
                var e = e ? h.currItem.img : h.st.zoom.opener(h.currItem.el || h.currItem)
                  ...
                  , e = (t.top -= u(window).scrollTop() - n,
                {
                    width: e.width(),
                    height: (k ? e.innerHeight() : e[0].offsetHeight) - r - n
                });
                return (O = void 0 === O ? void 0 !== document.createElement("p").style.MozTransform : O) ? e["-moz-transform"] = e.transform = "translate(" + t.left + "px," + t.top + "px)" : (e.left = t.left,
                e.top = t.top),
                e
            }
        }
    });
    var O, q = "iframe", H = (u.magnificPopup.registerModule(q, {
        options: {
    ...
    u.magnificPopup.registerModule(H, {
        ...
        proto: {
            initRetina: function() {
                ...
                r = n.ratio,
                1 < (r = isNaN(r) ? r() : r)) && (c("ImageHasSize." + H, function(e, t) {
                    t.img.css({
...
function(e, t) {
    ...
    function T(e, t, n, r) {
        t.emitEvents && "function" == typeof w.CustomEvent && (t = new CustomEvent(e,{
            bubbles: !0,
            detail: {
                anchor: n,
                toggle: r
    ...
    return function(r, e) {
        function t(e) {
            if (!e.defaultPrevented && !(0 !== e.button || e.metaKey || e.ctrlKey || e.shiftKey) && "closest"in e.target && (o = e.target.closest(r)) && "a" === o.tagName.toLowerCase() && !e.target.closest(v.ignore) && o.hostname === w.location.hostname && o.pathname === w.location.pathname && /#/.test(o.href)) {
                var t, n;
                try {
                ...
                n = v,
                history.replaceState && n.updateURL && !history.state && (e = (e = w.location.hash) || "",
                history.replaceState({
                    smoothScroll: JSON.stringify(n),
                    anchor: e || w.pageYOffset
                }, document.title, e || w.location.href)),
                x.animateScroll(t, o))
            }
        }
        function n(e) {
            var t;
            null === history.state || !history.state.smoothScroll || history.state.smoothScroll !== JSON.stringify(v) || "string" == typeof (t = history.state.anchor) && t && !(t = document.querySelector(i(history.state.anchor))) || x.animateScroll(t, null, {
                updateURL: !1
            })
        }
        var v, o, y, b, x = {
        ...
        x.animateScroll = function(r, o, e) {
            x.cancelScroll();
            var i, a, s, l, u, c, d, f, p, h, t, m = C(v || E, e || {}), g = "[object Number]" === Object.prototype.toString.call(r), e = g || !r.tagName ? null : r;
            (g || e) && (i = w.pageYOffset,
            ...
            h = function(e) {
                ...
                p(f, a) || (b = w.requestAnimationFrame(h),
                d = e)
            }
            ,
            ...
            e = r,
            t = m,
            g || history.pushState && t.updateURL && history.pushState({
                smoothScroll: JSON.stringify(t),
                anchor: e.id
            }, document.title, e === document.documentElement ? "#top" : "#" + e.id),
            "matchMedia"in w && w.matchMedia("(prefers-reduced-motion)").matches ? w.scrollTo(0, Math.floor(a)) : (T("scrollStart", m, r, o),
            x.cancelScroll(!0),
...
$(document).ready(function() {
    ...
    function o(e) {
        for (var t, n = (e = e.target).nextElementSibling; n && "code" !== n.tagName.toLowerCase(); )
            n = n.nextElementSibling;
        if (n)
            return t = function(e) {
                if (document.queryCommandEnabled("copy") && navigator.clipboard)
                    return navigator.clipboard.writeText(e).then(()=>!0, ()=>console.error("Failed to copy text to clipboard: " + e)),
                    !0;
                var t = "rtl" === document.documentElement.getAttribute("dir")
                  , n = document.createElement("textarea")
                  , t = (n.className = "clipboard-helper",
                ...
                t
            }((n = (t = n.querySelector("td.code, td.rouge-code")) ? t : n).innerText),
            e.focus(),
            t;
    ...
    // document.querySelector(".page__content").querySelectorAll("h1, h2, h3, h4, h5, h6").forEach(function(e) {
    //     var t, n = e.getAttribute("id");
    //     n && ((t = document.createElement("a")).className = "header-link",
    //     t.href = "#" + n,
    //     t.innerHTML = '<span class="sr-only">Permalink</span><i class="fas fa-link"></i>',
    //     t.title = "Permalink",
    //     e.appendChild(t))
    // });
    window.enable_copy_code_button && document.querySelectorAll(".page__content pre > code").forEach(function(e, t, n) {
        var r, e = e.parentElement;
        "code" === e.firstElementChild.tagName.toLowerCase() && ((r = document.createElement("button")).title = "Copy to clipboard",
        r.className = "clipboard-copy-button",
        r.innerHTML = '<span class="sr-only">Copy code</span><i class="far fa-copy"></i>',
